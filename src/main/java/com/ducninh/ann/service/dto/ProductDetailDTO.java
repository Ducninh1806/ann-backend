...
public class ProductDetailDTO {
    ...
    private List<String> sizesName = new ArrayList<>();
    private List<String> colorsName = new ArrayList<>();
    ...
    public void setSizesName(List<String> sizesName) {
    ...
    public void setColorsName(List<String> colorsName) {
